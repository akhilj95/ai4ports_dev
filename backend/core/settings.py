...
SECRET_KEY = 'django-insecure-f6y-n^&t&&!q8=uush2y1stf)d&x=ma*vxgqk8^$=!ik+5s=c6'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': 'ardupilot_parser.log',
        },
    },
    'loggers': {
        'django.core.management.commands.parse_ardupilot_logs': {
            'handlers': ['file'],
            'level': 'INFO',
            'propagate': True,
        },
